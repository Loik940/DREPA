...
L’ordre 10 à 19 est obligatoire. La migration 19 impose un déploiement coordonné avec l’APK qui utilise les nouvelles RPC. Les migrations déjà appliquées ne doivent jamais être modifiées.
