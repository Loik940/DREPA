...
- les dix-neuf premières migrations sont appliquées sur le projet actuel désigné staging ;
- `20260819190000_fix_security_regressions.sql` reste à valider puis appliquer ;
